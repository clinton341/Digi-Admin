...
?>
  ...
  <tr>
        ...
        <td><a href="<?php echo(URLROOT) ?>/staff/staff_portal.php?id=8&staff_id=<?php echo $staff_id; ?>" style="color: #1E90FF;">View </a>&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;<a href="delete_staff.php?id=<?php echo $staff_id;?>" onclick="return confirm('ARE YOU SURE YOU WANT TO DELETE THIS RECORD?');" style="cursor: pointer; color: red;"> Delete</a></td> 
  </tr>
<?php        
    }
} else {
